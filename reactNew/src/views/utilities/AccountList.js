...
const AccountList = () => {
    ...
    const fetchAccountsTypes = async () => {
        try {
            ...
            const accountsTypes = response.data.data; // Extract the array of accounts
    ...
    const handleUpdateButtonClick = (account) => {
        setFormData({
            ...
            accountHolder: {
                firstName: account.accountHolde?.firstName,
        ...
        setShowCreateModal(true); // Open the modal with the account data populated
    };
